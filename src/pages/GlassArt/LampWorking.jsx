...
const LampWorking = () => {
  ...
  const craftsLampworking = loadedData.filter(craft=> craft.subcategory_Name  === 'Lampworking');
  console.log(craftsLampworking)
      ...
      <div>
        ...
        <div className="my-4 ">
          <h2 className="text-2xl p-4 font-bold text-center max-w-md mx-auto">
            Here you will get all craft related to Lamp Working
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-3">
            {
              craftsLampworking.map(craft =>
                <div key={craft._id}
