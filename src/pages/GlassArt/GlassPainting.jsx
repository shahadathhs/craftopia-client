...
const GlassPainting = () => {
  ...
  const craftsGlassPainting = loadedData.filter(craft=> craft.subcategory_Name  === 'Glass Painting');
  console.log(craftsGlassPainting)
      ...
      <div>
        ...
        <div className="my-4 ">
          <h2 className="text-2xl p-4 font-bold text-center max-w-md mx-auto">
            Here you will get all craft related to Glass Painting
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-3">
            {
              craftsGlassPainting.map(craft =>
                <div key={craft._id}
