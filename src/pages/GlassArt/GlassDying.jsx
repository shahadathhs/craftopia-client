...
const GlassDying = () => {
  ...
  const craftsGlassDying = loadedData.filter(craft=> craft.subcategory_Name  === 'Glass Dying & Staining');
  console.log(craftsGlassDying)
      ...
      <div>
        ...
        <div className="my-4 ">
          <h2 className="text-2xl p-4 font-bold text-center max-w-md mx-auto">
            Here you will get all craft related to Glass Dying & Staining
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-3">
            {
              craftsGlassDying.map(craft =>
                <div key={craft._id}
